...
and the residual ones are named. #787 (flipping that branch fail-closed) is the backstop that makes
the residue safe rather than silent, which is why slice 6 is blocked on it.

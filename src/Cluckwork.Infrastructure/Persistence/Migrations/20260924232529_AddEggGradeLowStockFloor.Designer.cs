...
namespace Cluckwork.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924232529_AddEggGradeLowStockFloor")]
    partial class AddEggGradeLowStockFloor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cluckwork.Domain.Eggs.EggGrade", b =>
                {
                    ...
                    b.ToTable("EggGrades", t =>
                        {
                            t.HasCheckConstraint("CK_EggGrades_LowStockFloor", "\"LowStockFloor\" IS NULL OR \"LowStockFloor\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Cluckwork.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("StepUpLogoutEpoch")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

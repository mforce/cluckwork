...
namespace Cluckwork.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260723235611_AddRefreshTokenGraceAndConcurrency")]
    partial class AddRefreshTokenGraceAndConcurrency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cluckwork.Domain.Accounts.FarmLogo", b =>
                {
                    ...
                    b.ToTable("FarmLogos", t =>
                        {
                            t.HasCheckConstraint("ck_farm_logos_content_length", "octet_length(\"Content\") > 0 AND octet_length(\"Content\") <= 1048576");
                        });
                });

...
export const tl = {
  ...
  dashboard: {
    ...
    trendWeekTip_one: "{{from}} – {{to}}, {{days}} araw – {{total}} itlog, {{perDay}} bawat araw",
    trendWeekTip_other: "{{from}} – {{to}}, {{days}} araw – {{total}} itlog, {{perDay}} bawat araw",
    trendWeekTipPartial_one: "{{from}} – {{to}}, {{days}} araw – {{total}} itlog, {{perDay}} bawat araw, hindi lahat ng kawan ay may tala bawat araw",
    trendWeekTipPartial_other: "{{from}} – {{to}}, {{days}} araw – {{total}} itlog, {{perDay}} bawat araw, hindi lahat ng kawan ay may tala bawat araw",

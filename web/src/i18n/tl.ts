...
export const tl = {
  ...
  dashboard: {
    ...
    closeFlockSelectorAction: "Isara ang pumipili ng kawan",
    searchAccessibleFlocksLabel: "Maghanap ng accessible na kawan",
    searchByNamePlaceholder: "Maghanap ayon sa pangalan",
    matchingFlocksCount_one: "{{count}} tumutugmang kawan",
    matchingFlocksCount_other: "{{count}} tumutugmang kawan",

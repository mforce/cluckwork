...
export const es = {
  ...
  dashboard: {
    ...
    todayInCountAtLeast: "{{in}} de {{count}}+ casetas registradas",
    ...
    pagerHousesAtLeast: "Naves {{first}} a {{last}} de {{total}}+",
    housesIncompleteNotice: "Se muestran las primeras {{total}} naves. Esta granja tiene más.",

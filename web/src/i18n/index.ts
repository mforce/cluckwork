...
// English-only today. Add codes here as packs ship; resolveLanguage + the
// language selector both key off this list, so a pack becomes selectable and
// resolvable the moment it is added.

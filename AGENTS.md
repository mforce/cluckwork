...
- **The version comes from conventional commits, damped below 1.0.0** (`feat!:` → minor; everything else → patch). The mapping flips **silently at 1.0.0** — reach it deliberately with a `Release-As:` footer.

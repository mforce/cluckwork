...
- [X] T038 [P] [US3] Implement exact-value retention and explicit unavailable states for History, Feed, and Expenses lifecycles in `web/src/routes/HistoryPage.tsx`, `web/src/routes/FeedPage.tsx`, and `web/src/routes/ExpensesPage.tsx`.

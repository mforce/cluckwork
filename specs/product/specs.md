...
New to the domain? Read [`GLOSSARY.md`](./GLOSSARY.md) first — it defines the
terms this document uses without re-introducing them.

## Contents

<!-- toc:begin — generated by tools/docs/toc.py; do not edit by hand -->

  - [0.1 Naming Update](#01-naming-update)
  - [0. v4 Reconciliation Summary](#0-v4-reconciliation-summary)
- **[1. Product Goal](#1-product-goal)**
- **[2. Non-Goals for Phase 1](#2-non-goals-for-phase-1)**
- **[3. Core Architecture](#3-core-architecture)**
  - [3.1 Tenant/account hierarchy](#31-tenantaccount-hierarchy)
  - [3.2 Farm hierarchy](#32-farm-hierarchy)
  - [3.3 Flock model](#33-flock-model)
  - [3.4 Valid flock purpose/model combinations](#34-valid-flock-purposemodel-combinations)
- **[4. Core Design Principles](#4-core-design-principles)**
  - [4.1 Ledger-first inventory](#41-ledger-first-inventory)
  - [4.2 Traceability-first eggs](#42-traceability-first-eggs)
  - [4.3 Product-generic sales](#43-product-generic-sales)
  - [4.4 Operational dates](#44-operational-dates)
  - [4.5 Farm localization settings](#45-farm-localization-settings)
    - [Canonical fields](#canonical-fields)
    - [Phase 1 currency rule](#phase-1-currency-rule)
    - [Money storage rule](#money-storage-rule)
    - [Display rule](#display-rule)
    - [Operational date rule](#operational-date-rule)
    - [UI language vs farm locale](#ui-language-vs-farm-locale)
  - [4.6 Financial row currency immutability](#46-financial-row-currency-immutability)
    - [Row-level currency rule](#row-level-currency-rule)
    - [Required financial row snapshots](#required-financial-row-snapshots)
    - [Farm currency change rule](#farm-currency-change-rule)
    - [Currency derivation fallback](#currency-derivation-fallback)
- **[5. Users, Roles, and Scope](#5-users-roles-and-scope)**
  - [5.1 Roles](#51-roles)
  - [5.2 Role assignments](#52-role-assignments)
  - [5.3 Scope rules](#53-scope-rules)
- **[6. Unified Phase Plan](#6-unified-phase-plan)**
  ...
  - [Phase 5 — Breeder and hatchery](#phase-5--breeder-and-hatchery)
- **[7. Unified Sprint List](#7-unified-sprint-list)**
  - [Sprint A — Foundation (MVP) — mostly built](#sprint-a--foundation-mvp--mostly-built)
  - [Sprint B — Daily entry (MVP) — mostly built](#sprint-b--daily-entry-mvp--mostly-built)
  - [Sprint C — Egg lots and stock (MVP) — the critical bridge](#sprint-c--egg-lots-and-stock-mvp--the-critical-bridge)
  - [Sprint D — Sales (MVP) — mostly built](#sprint-d--sales-mvp--mostly-built)
  - [Sprint UI — Web client (MVP) — not started](#sprint-ui--web-client-mvp--not-started)
  - [Sprint E — Phase 1.1 operational fill](#sprint-e--phase-11-operational-fill)
  - [Sprint F — Phase 1.1 reporting and audit](#sprint-f--phase-11-reporting-and-audit)
  - [Sprint G — Phase 1.5 hardening](#sprint-g--phase-15-hardening)
- **[8. Daily Entry](#8-daily-entry)**
  - [8.1 States](#81-states)
  - [8.2 Uniqueness](#82-uniqueness)
  - [8.3 Daily entry table](#83-daily-entry-table)
  - [8.5 Daily-entry speed acceptance criteria](#85-daily-entry-speed-acceptance-criteria)
  - [8.4 Modular sections](#84-modular-sections)
    - [Core section](#core-section)
    - [Egg section](#egg-section)
    - [Weight section](#weight-section)
    - [Breeding section](#breeding-section)
- **[9. Egg Production, Egg Lots, and Egg Inventory](#9-egg-production-egg-lots-and-egg-inventory)**
  - [9.1 Egg grades](#91-egg-grades)
  - [9.2 Daily production by grade](#92-daily-production-by-grade)
  - [9.3 Egg lots](#93-egg-lots)
  - [9.4 Egg inventory movements](#94-egg-inventory-movements)
  - [9.5 Egg movement rules](#95-egg-movement-rules)
  - [9.6 Traceability chain](#96-traceability-chain)
  - [9.7 Egg unit conversions](#97-egg-unit-conversions)
    - [Conversion rules](#conversion-rules)
  - [9.8 Grading and packing assumption](#98-grading-and-packing-assumption)
    - [Phase 1 assumption](#phase-1-assumption)
    - [Reserved path — regrade / repack (Phase 1.5)](#reserved-path--regrade--repack-phase-15)
- **[10. Product Catalog and Sales](#10-product-catalog-and-sales)**
  - [10.1 Products](#101-products)
  - [10.2 Egg product mappings](#102-egg-product-mappings)
  - [10.3 Customers](#103-customers)
  - [10.4 Sales orders](#104-sales-orders)
  - [10.5 Sales order items](#105-sales-order-items)
  - [10.6 Egg allocations](#106-egg-allocations)
  - [10.7 Future live bird allocations](#107-future-live-bird-allocations)
  - [10.8 Future meat allocations](#108-future-meat-allocations)
  - [10.9 Sale confirmation transaction](#109-sale-confirmation-transaction)
  - [10.9.1 Egg-lot allocation concurrency rule](#1091-egg-lot-allocation-concurrency-rule)
  - [10.10 Withdrawal rule for egg sales](#1010-withdrawal-rule-for-egg-sales)
  - [10.11 Payments](#1011-payments)
- **[11. Live Bird Inventory and Mortality](#11-live-bird-inventory-and-mortality)**
  - [11.1 Bird inventory movements](#111-bird-inventory-movements)
  - [11.2 Placement rule](#112-placement-rule)
  - [11.3 Mortality records](#113-mortality-records)
  - [11.4 Current live birds](#114-current-live-birds)
- **[12. Feed, Water, and General Inventory](#12-feed-water-and-general-inventory)**
  - [12.1 Inventory items](#121-inventory-items)
  - [12.2 Inventory lots](#122-inventory-lots)
  - [12.3 Inventory movements](#123-inventory-movements)
  - [12.4 Feed usage](#124-feed-usage)
  - [12.5 Water usage](#125-water-usage)
  - [12.6 Water-to-feed ratio](#126-water-to-feed-ratio)
- **[13. Medication, Withdrawal, Vaccines, and Additives](#13-medication-withdrawal-vaccines-and-additives)**
  - [13.1 Medication applications](#131-medication-applications)
  - [13.2 Active withdrawal](#132-active-withdrawal)
  - [13.3 Egg lot restriction](#133-egg-lot-restriction)
  - [13.4 Vaccination records](#134-vaccination-records)
  - [13.5 Additive applications](#135-additive-applications)
- **[14. Health, Welfare, and Beak Treatment](#14-health-welfare-and-beak-treatment)**
  - [14.1 Health events](#141-health-events)
  - [14.2 Welfare tags](#142-welfare-tags)
  - [14.3 Beak treatment](#143-beak-treatment)
- **[15. Weight and Growth Records](#15-weight-and-growth-records)**
- **[16. Expenses and Profitability](#16-expenses-and-profitability)**
- **[17. Alerts, Tasks, Reconciliation, Import, and Backup](#17-alerts-tasks-reconciliation-import-and-backup)**
  - [17.1 Alerts](#171-alerts)
  - [17.2 Tasks](#172-tasks)
  - [17.3 Inventory reconciliation](#173-inventory-reconciliation)
  - [17.4 Legacy import](#174-legacy-import)
  - [17.5 Backup/recovery](#175-backuprecovery)
- **[18. Audit Log](#18-audit-log)**
- **[19. Reports and KPIs](#19-reports-and-kpis)**
  - [19.1 Phase 1 reports](#191-phase-1-reports)
  - [19.2 Traceability report](#192-traceability-report)
  - [19.3 KPI formulas](#193-kpi-formulas)
- **[20. Use Cases](#20-use-cases)**
  - [UC-001 Create account](#uc-001-create-account)
  - [UC-010 Create farm, house, and flock](#uc-010-create-farm-house-and-flock)
  - [UC-011 Configure farm localization](#uc-011-configure-farm-localization)
  - [UC-012 Select UI language](#uc-012-select-ui-language)
  - [UC-020 Create daily entry draft](#uc-020-create-daily-entry-draft)
  - [UC-021 Submit daily entry](#uc-021-submit-daily-entry)
  - [UC-030 Sell egg product](#uc-030-sell-egg-product)
  - [UC-031 Manually allocate egg lots](#uc-031-manually-allocate-egg-lots)
  - [UC-032 Sell non-egg product later](#uc-032-sell-non-egg-product-later)
  - [UC-040 Record medication with egg withdrawal](#uc-040-record-medication-with-egg-withdrawal)
  - [UC-050 Record weight](#uc-050-record-weight)
- **[21. Wireframe Coverage](#21-wireframe-coverage)**
  - [21.1 Current v4 wireframes](#211-current-v4-wireframes)
  - [21.2 Carried forward from v2 unchanged](#212-carried-forward-from-v2-unchanged)
  - [21.3 Superseded v2 wireframes](#213-superseded-v2-wireframes)
  - [21.4 Wireframe intent](#214-wireframe-intent)
- **[22. Transaction Boundaries](#22-transaction-boundaries)**
- **[23. Idempotency](#23-idempotency)**
- **[24. Data Storage Rules](#24-data-storage-rules)**
  - [Money](#money)
  - [Egg quantities](#egg-quantities)
  - [Live bird quantities](#live-bird-quantities)
  - [Meat quantities](#meat-quantities)
  - [User language](#user-language)
  - [Soft delete](#soft-delete)
- **[25. Final v4 Summary](#25-final-v4-summary)**
